...
-- Creating tabs
local Tabs = {
    Home = Window:AddTab({ Title = "Home [หน้าแรก] ", Icon = "home" }),
    Main = Window:AddTab({ Title = "Main [หน้าหลัก] ", Icon = "code" }),
    Teleports = Window:AddTab({ Title = "Teleports [วาป] ", Icon = "compass" }),
    Misc = Window:AddTab({ Title = "Misc [เบ็ดเตล็ด] ", Icon = "file-text" }),
    Fun = Window:AddTab({ Title = "Fun [ของเสริม] ", Icon = "coffee" }),
    Webhook = Window:AddTab({ Title = "Webhook [แจ้งเตือน] ", Icon = "clock" }),
    Premium = Window:AddTab({ Title = "Premium [พรีเมียม] ", Icon = "diamond" }),
...
do
    local _25ms=Tabs.Home:AddButton({
        Title = "กดติดตาม YouTube : SitX",
        Description = "https://www.youtube.com/@SitXx, กดติดตามเพื่อเป็นกำลังใจ",
        Callback = function()
            setclipboard("https://www.youtube.com/@SitXx")
        end
    })
